...
@export var shiny_adjacent_texture:Texture2D
@export var shiny_column_texture:Texture2D
@export var shiny_texture:Texture2D
@export var shiny_row_texture:Texture2D
...
func make_pseudo_adjacent_bomb():
	...
	is_special=false
	matched=false
	$Sprite2D.texture=shiny_adjacent_texture
