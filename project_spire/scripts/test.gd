...
var array1=[Vector2(4,0), Vector2(4,1), Vector2(4,2), Vector2(4,3), Vector2(4,4), Vector2(4,5), Vector2(4,6), Vector2(3,7), Vector2(5,7), Vector2(2,6), Vector2(1,5), Vector2(0,4), Vector2(6,6), Vector2(7,5), Vector2(8,4), Vector2(7,7), Vector2(1,7)]
var array1_healths=[]
