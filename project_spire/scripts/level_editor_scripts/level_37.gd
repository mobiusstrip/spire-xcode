...
var ice_healths=[]
var lock_spaces=[]
var swirl_spaces=[Vector2(0,0), Vector2(2,0), Vector2(3,0), Vector2(4,0), Vector2(5,0), Vector2(6,0), Vector2(7,1), Vector2(6,1), Vector2(5,1), Vector2(3,1), Vector2(2,1), Vector2(1,1), Vector2(0,2), Vector2(2,2), Vector2(3,2), Vector2(4,2), Vector2(5,2), Vector2(6,2), Vector2(7,2), Vector2(8,2), Vector2(8,3), Vector2(6,3), Vector2(5,3), Vector2(3,3), Vector2(2,3), Vector2(1,3), Vector2(0,3), Vector2(4,4), Vector2(5,4), Vector2(6,4), Vector2(7,4), Vector2(8,5), Vector2(6,5), Vector2(5,5), Vector2(3,5), Vector2(2,5), Vector2(1,5), Vector2(0,5), Vector2(0,6), Vector2(2,6), Vector2(3,6), Vector2(4,6), Vector2(5,6), Vector2(6,6), Vector2(7,6), Vector2(8,6), Vector2(7,7), Vector2(6,7), Vector2(5,7), Vector2(3,7), Vector2(2,7), Vector2(1,7), Vector2(0,8), Vector2(2,8), Vector2(3,8), Vector2(4,8), Vector2(5,8), Vector2(6,8)]
var concrete_spaces=[]
var concrete_healths=[]
var slime_spaces=[]
var empty_spaces=[Vector2(7,8), Vector2(8,8), Vector2(8,7), Vector2(7,0), Vector2(8,0), Vector2(8,1), Vector2(0,4), Vector2(1,4), Vector2(2,4), Vector2(3,4)]
...
var signal_count=13 #DONT FORGET SIGNAL COUNT & COMMENT FIRST LINE IF THERE ARE OTHERS
func level_editor():
	emit_signal("spawn_debug",1,8,"green","row")
	emit_signal("spawn_debug",-0,7,"green","row")
	emit_signal("spawn_debug",1,6,"green","row")
	emit_signal("spawn_debug",4,7,"blue","row")
	emit_signal("spawn_debug",4,5,"orange","row")
	emit_signal("spawn_debug",7,5,"green","row")
	emit_signal("spawn_debug",7,3,"green","row")
	emit_signal("spawn_debug",4,3,"blue","row")
	emit_signal("spawn_debug",4,1,"orange","row")
	emit_signal("spawn_debug",1,-0,"green","row")
	emit_signal("spawn_debug",0,1,"green","row")
	emit_signal("spawn_debug",1,2,"green","row")
	emit_signal("spawn_debug",8,4,"green","row")
