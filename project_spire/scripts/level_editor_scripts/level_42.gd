...
var ice_healths=[]
var lock_spaces=[]
var swirl_spaces=[Vector2(3,7), Vector2(4,7), Vector2(5,7), Vector2(5,6), Vector2(5,5), Vector2(5,4), Vector2(6,4), Vector2(6,3), Vector2(7,3), Vector2(8,3), Vector2(3,6), Vector2(3,5), Vector2(3,4), Vector2(2,4), Vector2(2,3), Vector2(1,3), Vector2(0,3), Vector2(4,2), Vector2(3,1), Vector2(5,1)]
var concrete_spaces=[]
var concrete_healths=[]
var slime_spaces=[] 
var empty_spaces=[Vector2(1,8), Vector2(2,8), Vector2(2,7), Vector2(7,8), Vector2(6,8), Vector2(6,7), Vector2(0,0), Vector2(0,1), Vector2(1,0), Vector2(7,0), Vector2(8,0), Vector2(8,1)]
var marmalade_spaces=[Vector2(3,7), Vector2(4,7), Vector2(5,7), Vector2(5,6), Vector2(5,5), Vector2(5,4), Vector2(6,4), Vector2(6,3), Vector2(7,3), Vector2(8,3), Vector2(3,6), Vector2(3,5), Vector2(3,4), Vector2(2,4), Vector2(2,3), Vector2(1,3), Vector2(0,3), Vector2(4,2), Vector2(3,1), Vector2(5,1)]
...
func level_editor():
	emit_signal("spawn_debug",3,8,"green","sinker")
	emit_signal("spawn_debug",4,8,"green","sinker")
	emit_signal("spawn_debug",5,8,"green","sinker")
