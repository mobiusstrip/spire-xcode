...
var slime_spaces=[]
var empty_spaces=[Vector2(6,7), Vector2(5,6), Vector2(5,0), Vector2(5,1), Vector2(5,2), Vector2(5,3), Vector2(5,4), Vector2(5,5), Vector2(5,7), Vector2(5,8), Vector2(6,8), Vector2(8,7), Vector2(8,8), Vector2(7,5), Vector2(6,4), Vector2(8,4), Vector2(7,3), Vector2(6,2), Vector2(8,2), Vector2(8,1), Vector2(6,1), Vector2(6,0), Vector2(7,0), Vector2(8,0)]
...
var signal_count=15 #DONT FORGET SIGNAL COUNT & COMMENT FIRST LINE IF THERE ARE OTHERS
func level_editor():
	emit_signal("spawn_debug",4,8,"purple","adjacent")
	emit_signal("spawn_debug",4,6,"green","sinker")
	emit_signal("spawn_debug",2,6,"green","sinker")
	emit_signal("spawn_debug",3,4,"green","sinker")
	emit_signal("spawn_debug",4,4,"green","adjacent")
	emit_signal("spawn_debug",1,4,"purple","row")
	emit_signal("spawn_debug",-0,3,"orange","adjacent")
	emit_signal("spawn_debug",0,2,"green","sinker")
	emit_signal("spawn_debug",3,0,"blue","adjacent")
	emit_signal("spawn_debug",7,8,"green","sinker")
	emit_signal("spawn_debug",7,7,"green","sinker")
	emit_signal("spawn_debug",8,6,"green","sinker")
	emit_signal("spawn_debug",6,6,"green","sinker")
	emit_signal("spawn_debug",7,2,"blue","color")
	emit_signal("spawn_debug",7,1,"green","adjacent")
