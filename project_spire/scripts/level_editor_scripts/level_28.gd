...
var ice_spaces=[]
var ice_healths=[]
var lock_spaces=[Vector2(0,1), Vector2(1,2), Vector2(2,3), Vector2(8,1), Vector2(7,2), Vector2(6,3), Vector2(4,3), Vector2(4,4), Vector2(4,1), Vector2(3,0), Vector2(4,0), Vector2(5,0)]
var concrete_spaces=[Vector2(2,0), Vector2(0,0), Vector2(1,1), Vector2(2,2), Vector2(1,0), Vector2(2,1), Vector2(3,2), Vector2(3,1), Vector2(8,0), Vector2(7,1), Vector2(6,2), Vector2(7,0), Vector2(6,1), Vector2(5,2), Vector2(6,0), Vector2(5,1)]
...
func level_editor():
	emit_signal("spawn_debug",4,2,"blue","column")
	emit_signal("spawn_debug",2,4,"blue","column")
	emit_signal("spawn_debug",6,4,"green","column")
	emit_signal("spawn_debug",4,6,"green","column")
	emit_signal("spawn_debug",7,2,"green","adjacent")
	emit_signal("spawn_debug",1,2,"orange","adjacent")
	emit_signal("spawn_debug",4,4,"green","sinker")
